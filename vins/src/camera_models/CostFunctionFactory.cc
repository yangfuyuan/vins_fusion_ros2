#include "vins/camera_models/CostFunctionFactory.h"
...
class ReprojectionError3 {
 public:
  ...
  ReprojectionError3(const std::vector<double>& intrinsic_params,
                     ...
                     const Eigen::Vector2d& observed_p, bool optimize_cam_odo_z)
      : m_intrinsic_params(intrinsic_params),
        m_odo_pos(odo_pos),
        m_odo_att(odo_att),
        m_observed_p(observed_p),
...
class StereoReprojectionError {
 public:
  ...
  bool operator()(const T* const intrinsic_params_l,
    ...
    CameraT::spaceToPlane(intrinsic_params_r, q_r.coeffs().data(), t_r.data(),
                          P, predicted_p_r);
  ...
  switch (flags) {
    case CAMERA_INTRINSICS | CAMERA_POSE:
      switch (camera->modelType()) {
        ...
        case Camera::MEI:
          costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError1<CataCamera>, 2,
                                              9, 4, 3>(
                  new ReprojectionError1<CataCamera>(observed_P, observed_p));
          break;
        case Camera::SCARAMUZZA:
          costFunction =
              new ceres::AutoDiffCostFunction<ComprehensionError<OCAMCamera>, 4,
                                              SCARAMUZZA_CAMERA_NUM_PARAMS, 4,
                                              3>(
    ...
    case CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE:
      switch (camera->modelType()) {
        ...
        case Camera::PINHOLE:
          costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError1<PinholeCamera>,
                                              2, 4, 3, 3, 3>(
                  new ReprojectionError1<PinholeCamera>(
                      intrinsic_params, observed_P, observed_p));
          break;
        case Camera::PINHOLE_FULL:
          costFunction = new ceres::AutoDiffCostFunction<
  ...
  switch (flags) {
    case CAMERA_POSE | POINT_3D:
      switch (camera->modelType()) {
        ...
        case Camera::PINHOLE:
          costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError2<PinholeCamera>,
                                              2, 4, 3, 3>(
        ...
        case Camera::MEI:
          costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError2<CataCamera>, 2, 4, 3, 3>(
              new ReprojectionError2<CataCamera>(intrinsic_params, observed_p));
          break;
        case Camera::SCARAMUZZA:
          costFunction = new ceres::AutoDiffCostFunction<
              ReprojectionError2<OCAMCamera>, 2, 4, 3, 3>(
    ...
    case CAMERA_INTRINSICS | CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_3D_POSE |
      ...
      switch (camera->modelType()) {
        ...
        case Camera::PINHOLE_FULL:
          if (optimize_cam_odo_z) {
            costFunction = new ceres::AutoDiffCostFunction<
                ReprojectionError3<PinholeFullCamera>, 2, 12, 4, 3, 2, 1, 3>(
                new ReprojectionError3<PinholeFullCamera>(observed_p));
          } else {
            costFunction = new ceres::AutoDiffCostFunction<
                ReprojectionError3<PinholeFullCamera>, 2, 12, 4, 2, 2, 1, 3>(
                new ReprojectionError3<PinholeFullCamera>(observed_p));
          }
          break;
        case Camera::MEI:
    ...
    case CAMERA_INTRINSICS | CAMERA_ODOMETRY_TRANSFORM | ODOMETRY_6D_POSE |
      ...
      switch (camera->modelType()) {
        ...
        case Camera::PINHOLE_FULL:
          if (optimize_cam_odo_z) {
            costFunction = new ceres::AutoDiffCostFunction<
                ReprojectionError3<PinholeFullCamera>, 2, 12, 4, 3, 3, 3, 3>(
                new ReprojectionError3<PinholeFullCamera>(observed_p));
          } else {
            costFunction = new ceres::AutoDiffCostFunction<
                ReprojectionError3<PinholeFullCamera>, 2, 12, 4, 2, 3, 3, 3>(
                new ReprojectionError3<PinholeFullCamera>(observed_p));
          }
          break;
        case Camera::MEI:
        ...
        case Camera::PINHOLE:
          if (optimize_cam_odo_z) {
            costFunction = new ceres::AutoDiffCostFunction<
                ...
                new ReprojectionError3<PinholeCamera>(intrinsic_params, odo_pos,
                                                      odo_att, observed_p,
                                                      optimize_cam_odo_z));
          } else {
            costFunction = new ceres::AutoDiffCostFunction<
  ...
  switch (flags) {
    case POINT_3D:
      switch (camera->modelType()) {
        ...
        case Camera::MEI:
          costFunction =
              new ceres::AutoDiffCostFunction<ReprojectionError3<CataCamera>, 2,
                                              3>(
                  new ReprojectionError3<CataCamera>(
                      intrinsic_params, cam_odo_q, cam_odo_t, odo_pos, odo_att,
                      observed_p));
    ...
    case Camera::MEI:
      costFunction =
          new ceres::AutoDiffCostFunction<StereoReprojectionError<CataCamera>,
                                          4, 9, 9, 4, 3, 4, 3>(
              new StereoReprojectionError<CataCamera>(observed_P, observed_p_l,
                                                      observed_p_r));
      break;
    case Camera::SCARAMUZZA:
      costFunction = new ceres::AutoDiffCostFunction<
          StereoReprojectionError<OCAMCamera>, 4, SCARAMUZZA_CAMERA_NUM_PARAMS,
          SCARAMUZZA_CAMERA_NUM_PARAMS, 4, 3, 4, 3>(
          new StereoReprojectionError<OCAMCamera>(observed_P, observed_p_l,
                                                  observed_p_r));
      break;
  }
